...
namespace SalesWebMvc
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //Registro de injecao de dependencia do banco de dados
            services.AddDbContext<SalesWebMvcContext>(options =>
                    options.UseMySql(Configuration.GetConnectionString("SalesWebMvcContext"), builder =>
                    builder.MigrationsAssembly("SalesWebMvc")));
           
            //Registro de injecao de dependencia dos servicos
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, SeedingService seedingService)
        {
            ...
            else
            {
                ...
                // O valor padrão do HSTS é de 30 dias. Você pode querer mudar isso para cenários de produção, veja a documentação
