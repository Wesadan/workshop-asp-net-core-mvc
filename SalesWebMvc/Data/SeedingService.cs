...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        {//verifica se tem dados no BD
            ...
            Seller s1 = new Seller(1, "nome qualquer", "bob@gmail.com", new DateTime(1998, 1, 02), 1000.0, d1);
            Seller s2 = new Seller(2, "nome 2 qualquer", "Job@gmail.com", new DateTime(2018, 2, 03), 500.0, d2);
            Seller s3 = new Seller(3, "nome 3 qualquer", "Tob@gmail.com", new DateTime(2019, 3, 04), 500.0, d3);
            Seller s4 = new Seller(4, "nome 4 qualquer", "Mosk@gmail.com", new DateTime(2010, 4, 05), 500.0, d4);
            Seller s5 = new Seller(5, "Donald Blue", "donald@gmail.com", new DateTime(2000, 1, 9), 4000.0, d3);
            Seller s6 = new Seller(6, "Alex Pink", "estranho@gmail.com", new DateTime(1997, 3, 4), 3000.0, d2);

            //Inserindo dados na Tabela SalesRecord
            ...
            //Adiciona os dados acima no banco de dados(Add.Range permite adicionar varios objetos de uma vez)
            ...
            //chama o metodo para efetivar e salvar as alteraçãoes no BD 
